...
Abre RStudio, haz click en *File* ~> *New Project...* ~> *Version Control* ~> *Git*, y pega la "url que acabas de copiar" en el campo de *Repository URL:* y dale click a *Create Project*.
